<?php
  ...
  if (isset($_POST['submit'])) {
    ...
    try {
      ...
      $mail->Username = 'enquiry.educationindia@gmail.com';
      // Gmail Password
      $mail->Password = 'dkjhasaroj';
      $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
      $mail->Port = 587;

      // Email ID from which you want to send the email
      $mail->setFrom('enquiry.educationindia@gmail.com');
      // Recipient Email ID where you want to receive emails
      $mail->addAddress('sarthaksidhantisopolice@gmail.com');
